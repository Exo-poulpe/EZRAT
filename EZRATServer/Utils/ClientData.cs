...
namespace EZRATServer.Utils
{
    class ClientData
    {
        ...
        public string Ping { get => _ping; set => _ping = value; }


        public ClientData(int row,string ip = "0.0.0.0",string name = "Client",string user = "Victim",string window = "Windows 10",string ping = "0 ms")
        {
            this.Row = row;
            this.Ip = ip;
            this.Name = name;
